...
class Job(SQLModel, table=True):
    ...
    mode: ModeOfWork = Field(sa_column=Enum(ModeOfWork, name="modeofwork", native_enum=True, validate_strings=True, nullable=False),default=ModeOfWork.ONSITE)
    employment_type : EmploymentType = Field(sa_column=Enum(EmploymentType, name="employmenttype", native_enum=True, validate_strings=True, nullable=False),default=EmploymentType.FULL_TIME)
